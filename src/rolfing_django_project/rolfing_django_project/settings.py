"""
Django settings for rolfing_django_project project.
...
SECRET_KEY = 'django-insecure-f_(up2y=a*7!e%vj!*+tm1ht8bh$k6!foyhy6gwikhsp!^mfdz'
...
WSGI_APPLICATION = 'rolfing_django_project.wsgi.application'
...
CITIES_LIGHT_INCLUDE_COUNTRIES = ['RU', 'BY', 'AZ', ]


ROLF_USER_CONFIRM_PREFIX = 'user_confirm_'
ROLF_CONFIRM_DELAY_IN_SEC = 300

AUTH_USER_MODEL = 'web_app.RolfUser'

EMAIL_USE_TLS = True
EMAIL_HOST = os.getenv('ROLF_ADMIN_EMAIL_HOST')
EMAIL_PORT = 587

...
from web_app.models import RolfUser


class LoginUserForm(AuthenticationForm):
    username = CharField(label=pgettext_lazy('form_content', 'Login'),
                         widget=TextInput(attrs={'class': 'input-form form-control',
                                                 'placeholder': pgettext_lazy('form_content', "Login"),
                                                 'id': 'floatingInput',
                                                 'type': "text",
                                                 }))
    password = CharField(label=_('Password'),
                         widget=PasswordInput(attrs={'class': 'input-form form-control',
...
class RegisterUserForm(UserCreationForm):
    ...
    email = EmailField(label=_('Email'),
                       widget=EmailInput(attrs={'class': 'input-form form-control',
                                                'placeholder': _("Email"),
                                                'id': 'floatingInput',
                                                'type': "text",
                                                }))
